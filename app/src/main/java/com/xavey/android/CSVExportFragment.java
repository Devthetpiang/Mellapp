			...
			public void onClick(View v) {
				 SparseBooleanArray checked = listView.getCheckedItemPositions();
			        ...
			        for (int i = 0; i < checked.size(); i++) {
			           ...
			           /* // Add sporthttps://stackoverflow.com/questions/32035922/android-studio-if-else-conditions if it is checked i.e.) == TRUE!
			    https://stackoverflow.com/questions/32035922/android-studio-if-else-conditions        if (checked.valueAt(i))
